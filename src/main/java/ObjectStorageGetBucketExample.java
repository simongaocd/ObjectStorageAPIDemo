...
public class ObjectStorageGetBucketExample {
    public static void main(String[] args) throws Exception {
        ...
        //final String compartmentId = "ocid1.compartment.oc1..aaaaaaaa6ccsye7ra4g4xol3b7nn526efn2csg3sxnfflwysi6pptbkxioza";

        final String bucket = "bucket-20220629";
        ...
        String namespaceName = "cnl1j9yexfgh"; //Tenancy namespace

        System.out.println(" Get bucket request");
